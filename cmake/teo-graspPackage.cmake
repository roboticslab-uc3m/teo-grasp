...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "App for grasping objects with Teo using OpenRave to simulate it ")
set(CPACK_PACKAGE_DESCRIPTION_FILE "${CMAKE_SOURCE_DIR}/README.md")
set(CPACK_PACKAGE_CONTACT "Roboticslab team at UC3M")

# Package version.
set(CPACK_PACKAGE_VERSION_MAJOR "${teo-grasp_VERSION_MAJOR}")
set(CPACK_PACKAGE_VERSION_MINOR "${teo-grasp_VERSION_MINOR}")
set(CPACK_PACKAGE_VERSION_PATCH "${teo-grasp_VERSION_PATCH}")
...
if(WIN32 AND CMAKE_GENERATOR MATCHES "^Visual Studio")
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "teo-grasp_${CPACK_PACKAGE_VERSION}_${CPACK_SYSTEM_NAME}")

    # Miscellanea.
    set(CPACK_NSIS_HELP_LINK "http://github.com/roboticslab-uc3m/teo-grasp/")
...
if(UNIX)
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "teo-grasp-${CPACK_PACKAGE_VERSION}.${CPACK_SYSTEM_NAME}")
endif()
